...
* **Vector index** — a :class:`~immortals.memory.embedding.Embedder` vector per artifact and fact,
...
from immortals.memory.embedding import Embedder, cosine, default_embedder
